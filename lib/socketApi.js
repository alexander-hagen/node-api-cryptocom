...
CryptoSocket.prototype.login = async function(ws, api) {
  ...
  switch(ws.socket._ws.readyState) {
    case 1: ws.socket._ws.send(JSON.stringify(options)); break;
    case 0: setTimeout(this.login, 1000, ws, api); break;
    default: ws.socket._ws.terminate(); break;
  };
